...
void				process_int_printf(t_printf *data);
void				printf_parser(t_printf *data);
...
void				flaghandler_x(t_printf *data, int len, short hash,
												unsigned long long d);
void				printf_dispatcher(t_printf *data);
void				build_dispatcher_printf(t_printf *data);
void				init_printf_data(t_printf *data);
void				set_argnum_printf(t_printf *data, int d);
